	...
	class JS_Image {
	  ...
	  */
		...
		public function __construct( $path ) {
			// Detect GD and error out if necessary
			if( ! function_exists( 'gd_info' ) ) {
				trigger_error( 'The GD2 image library is required to modify images with JS_Image.' );
			}
...
//
	  ...
	  *
	  * @param string $path The path to save the image file to. The path must be writable to successfully save the file. You
	  *		can also optionally pass a null value to output the content directly to the browser.
	  ...
	  * @return bool Flag indicating whether the save was successful (true) or not (false). If a path was specified, the path
	  * 	to the new file is returned in place of the true value.
	  */
...
//
	  ...
	  * as possible. This produces a more accurate (and better looking) image than JS_Image::palette.
	  *
	  * @param int $colors The maximum number of colours to allow in the canvas.
	  * @param bool $dithering Flag indicating whether to dither the image (true) or not (false). Defaults to true.
	  * @return JS_Image The object for chaining.
